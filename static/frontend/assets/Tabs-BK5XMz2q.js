import{aA as K,bz as l,cL as E,dU as xt,c3 as yt,bZ as ee,d4 as St,G as y,H as n,aZ as wt,P as s,e as Ct,l as Rt,dJ as _e,dW as te,d8 as zt,dX as We,a9 as F,e4 as Le,aW as Tt,cG as $t,al as A,ak as Pt,bK as Ee,dd as _t,ca as Wt,b as Lt,d as Et,cO as kt,N as Bt,co as At,O as T,Q as jt,bi as oe,c$ as we,V as ie,e3 as se,cv as Ot,aM as It,e6 as Ht,m as Ft,a1 as Dt,db as Mt,cj as le,bs as Z,e1 as Nt,cF as Vt,dn as O,R as Q}from"./index-CWFO7ubw.js";import{u as fe}from"./Tooltip-Dn56tnsT.js";import{A as Xt}from"./Add-Nc0hn9l3.js";import{e as Ut,d as Ce,o as Gt}from"./FocusDetector-B9ICEykJ.js";import{a as Kt}from"./Input-rmIzEbo3.js";const Yt=Ce(".v-x-scroll",{overflow:"auto",scrollbarWidth:"none"},[Ce("&::-webkit-scrollbar",{width:0,height:0})]),qt=K({name:"XScroll",props:{disabled:Boolean,onScroll:Function},setup(){const e=E(null);function r(d){!(d.currentTarget.offsetWidth<d.currentTarget.scrollWidth)||d.deltaY===0||(d.currentTarget.scrollLeft+=d.deltaY+d.deltaX,d.preventDefault())}const i=xt();return Yt.mount({id:"vueuc/x-scroll",head:!0,anchorMetaName:Ut,ssr:i}),Object.assign({selfRef:e,handleWheel:r},{scrollTo(...d){var h;(h=e.value)===null||h===void 0||h.scrollTo(...d)}})},render(){return l("div",{ref:"selfRef",onScroll:this.onScroll,onWheel:this.disabled?void 0:this.handleWheel,class:"v-x-scroll"},this.$slots)}});var Jt=/\s/;function Zt(e){for(var r=e.length;r--&&Jt.test(e.charAt(r)););return r}var Qt=/^\s+/;function ea(e){return e&&e.slice(0,Zt(e)+1).replace(Qt,"")}var Re=NaN,ta=/^[-+]0x[0-9a-f]+$/i,aa=/^0b[01]+$/i,na=/^0o[0-7]+$/i,ra=parseInt;function ze(e){if(typeof e=="number")return e;if(yt(e))return Re;if(ee(e)){var r=typeof e.valueOf=="function"?e.valueOf():e;e=ee(r)?r+"":r}if(typeof e!="string")return e===0?e:+e;e=ea(e);var i=aa.test(e);return i||na.test(e)?ra(e.slice(2),i?2:8):ta.test(e)?Re:+e}var de=function(){return St.Date.now()},oa="Expected a function",ia=Math.max,sa=Math.min;function la(e,r,i){var c,d,h,v,u,p,g=0,x=!1,R=!1,$=!0;if(typeof e!="function")throw new TypeError(oa);r=ze(r)||0,ee(i)&&(x=!!i.leading,R="maxWait"in i,h=R?ia(ze(i.maxWait)||0,r):h,$="trailing"in i?!!i.trailing:$);function w(b){var L=c,D=d;return c=d=void 0,g=b,v=e.apply(D,L),v}function S(b){return g=b,u=setTimeout(W,r),x?w(b):v}function z(b){var L=b-p,D=b-g,M=r-L;return R?sa(M,h-D):M}function _(b){var L=b-p,D=b-g;return p===void 0||L>=r||L<0||R&&D>=h}function W(){var b=de();if(_(b))return P(b);u=setTimeout(W,z(b))}function P(b){return u=void 0,$&&c?w(b):(c=d=void 0,v)}function I(){u!==void 0&&clearTimeout(u),g=0,c=p=d=u=void 0}function j(){return u===void 0?v:P(de())}function m(){var b=de(),L=_(b);if(c=arguments,d=this,p=b,L){if(u===void 0)return S(p);if(R)return clearTimeout(u),u=setTimeout(W,r),w(p)}return u===void 0&&(u=setTimeout(W,r)),v}return m.cancel=I,m.flush=j,m}var da="Expected a function";function ca(e,r,i){var c=!0,d=!0;if(typeof e!="function")throw new TypeError(da);return ee(i)&&(c="leading"in i?!!i.leading:c,d="trailing"in i?!!i.trailing:d),la(e,r,{leading:c,maxWait:r,trailing:d})}const ba=y([y("@keyframes spin-rotate",`
 from {
 transform: rotate(0);
 }
 to {
