...
`,[A("scrollbar",`
 ...
 `),..._i({top:["right-start","left-start"],right:["top-end","bottom-end"],bottom:["right-end","left-end"],left:["top-start","bottom-start"]},(e,n)=>{const t=["right","left"].includes(n),o=t?"width":"height";return e.map(r=>{const a=r.split("-")[1]==="end",l=`calc((${`var(--v-target-${o}, 0px)`} - ${ie}) / 2)`,u=Pe(r);return Q(`[v-placement="${r}"] >`,[A("popover-shared",[J("center-arrow",[A("popover-arrow",`${n}: calc(max(${l}, ${u}) ${a?"+":"-"} var(--v-offset-${t?"left":"top"}));`)])])])})})]);function Pe(e){return["top","bottom"].includes(e.split("-")[0])?"var(--n-arrow-offset)":"var(--n-arrow-offset-vertical)"}function ge(e,n){const t=e.split("-")[0],o=["top","bottom"].includes(t)?"height: var(--n-space-arrow);":"width: var(--n-space-arrow);";return Q(`[v-placement="${e}"] >`,[A("popover-shared",`
...
`,[J("strong",`
 ...
 `),A("base-selection-label","background-color: var(--n-color-active);"),A("base-selection-tags","background-color: var(--n-color-active);")])]),J("disabled","cursor: not-allowed;",[D("arrow",`
 ...
 opacity: 0;
 `)]),["warning","error"].map(e=>J(`${e}-status`,[D("state-border",`border: var(--n-border-${e});`),xe("disabled",[Q("&:hover",[D("state-border",`
 box-shadow: var(--n-box-shadow-hover-${e});
 border: var(--n-border-hover-${e});
 `)]),J("active",[D("state-border",`
 box-shadow: var(--n-box-shadow-active-${e});
 border: var(--n-border-active-${e});
 `),A("base-selection-label",`background-color: var(--n-color-active-${e});`),A("base-selection-tags",`background-color: var(--n-color-active-${e});`)]),J("focus",[D("state-border",`
 ...
 `,[St({originalTransition:"background-color .3s var(--n-bezier), box-shadow .3s var(--n-bezier)"})])]),Tl=Object.assign(Object.assign({},ce.props),{to:Ie.propTo,bordered:{type:Boolean,default:void 0},clearable:Boolean,clearCreatedOptionsOnClear:{type:Boolean,default:!0},clearFilterAfterSelect:{type:Boolean,default:!0},options:{type:Array,default:()=>[]},defaultValue:{type:[String,Number,Array],default:null},keyboard:{type:Boolean,default:!0},value:[String,Number,Array],placeholder:String,menuProps:Object,multiple:Boolean,size:String,menuSize:{type:String},filterable:Boolean,disabled:{type:Boolean,default:void 0},remote:Boolean,loading:Boolean,filter:Function,placement:{type:String,default:"bottom-start"},widthMode:{type:String,default:"trigger"},tag:Boolean,onCreate:Function,fallbackOption:{type:[Function,Boolean],default:void 0},show:{type:Boolean,default:void 0},showArrow:{type:Boolean,default:!0},maxTagCount:[Number,String],ellipsisTagPopoverProps:Object,consistentMenuWidth:{type:Boolean,default:!0},virtualScroll:{type:Boolean,default:!0},labelField:{type:String,default:"label"},valueField:{type:String,default:"value"},childrenField:{type:String,default:"children"},renderLabel:Function,renderOption:Function,renderTag:Function,"onUpdate:value":[Function,Array],inputProps:Object,nodeProps:Function,ignoreComposition:{type:Boolean,default:!0},showOnFocus:Boolean,onUpdateValue:[Function,Array],onBlur:[Function,Array],onClear:[Function,Array],onFocus:[Function,Array],onScroll:[Function,Array],onSearch:[Function,Array],onUpdateShow:[Function,Array],"onUpdate:show":[Function,Array],displayDirective:{type:String,default:"show"},resetMenuOnOptionsChange:{type:Boolean,default:!0},status:String,showCheckmark:{type:Boolean,default:!0},scrollbarProps:Object,onChange:[Function,Array],items:Array}),Bl=he({name:"Select",props:Tl,slots:Object,setup(e){const{mergedClsPrefixRef:n,mergedBorderedRef:t,namespaceRef:o,inlineThemeDisabled:r,mergedComponentPropsRef:a}=Ae(e),i=ce("Select","-select",kl,or,e,n),l=E(e.defaultValue),u=te(e,"value"),f=In(u,l),d=E(!1),c=E(""),C=$t(e,["items","options"]),O=E([]),v=E([]),g=L(()=>v.value.concat(O.value).concat(C.value)),k=L(()=>{const{filter:s}=e;if(s)return s;const{labelField:w,valueField:$}=e;return(H,B)=>{if(!B)return!1;const N=B[w];if(typeof N=="string")return zn(H,N);const V=B[$];return typeof V=="string"?zn(H,V):typeof V=="number"?zn(H,String(V)):!1}}),x=L(()=>{if(e.remote)return C.value;{const{value:s}=g,{value:w}=c;return!w.length||!e.filterable?s:Pl(s,k.value,w,e.childrenField)}}),S=L(()=>{const{valueField:s,childrenField:w}=e,$=Ol(s,w);return tl(x.value,$)}),M=L(()=>Rl(g.value,e.valueField,e.childrenField)),m=E(!1),y=In(te(e,"show"),m),z=E(null),K=E(null),j=E(null),{localeRef:T}=Mt("Select"),F=L(()=>{var s;return(s=e.placeholder)!==null&&s!==void 0?s:T.value.placeholder}),W=[],I=E(new Map),G=L(()=>{const{fallbackOption:s}=e;if(s===void 0){const{labelField:w,valueField:$}=e;return H=>({[w]:String(H),[$]:H})}return s===!1?!1:w=>Object.assign(s(w),{value:w})});function ue(s){const w=e.remote,{value:$}=I,{value:H}=M,{value:B}=G,N=[];return s.forEach(V=>{if(H.has(V))N.push(H.get(V));else if(w&&$.has(V))N.push($.get(V));else if(B){const re=B(V);re&&N.push(re)}}),N}const _=L(()=>{if(e.multiple){const{value:s}=f;return Array.isArray(s)?ue(s):[]}return null}),U=L(()=>{const{value:s}=f;return!e.multiple&&!Array.isArray(s)?s===null?null:ue([s])[0]||null:null}),q=nr(e,{mergedSize:s=>{var w,$;const{size:H}=e;if(H)return H;const{mergedSize:B}=s||{};if(B!=null&&B.value)return B.value;const N=($=(w=a==null?void 0:a.value)===null||w===void 0?void 0:w.Select)===null||$===void 0?void 0:$.size;return N||"medium"}}),{mergedSizeRef:ae,mergedDisabledRef:le,mergedStatusRef:fe}=q;function oe(s,w){const{onChange:$,"onUpdate:value":H,onUpdateValue:B}=e,{nTriggerFormChange:N,nTriggerFormInput:V}=q;$&&de($,s,w),B&&de(B,s,w),H&&de(H,s,w),l.value=s,N(),V()}function X(s){const{onBlur:w}=e,{nTriggerFormBlur:$}=q;w&&de(w,s),$()}function pe(){const{onClear:s}=e;s&&de(s)}function b(s){const{onFocus:w,showOnFocus:$}=e,{nTriggerFormFocus:H}=q;w&&de(w,s),H(),$&&be()}function P(s){const{onSearch:w}=e;w&&de(w,s)}function Y(s){const{onScroll:w}=e;w&&de(w,s)}function ve(){var s;const{remote:w,multiple:$}=e;if(w){const{value:H}=I;if($){const{valueField:B}=e;(s=_.value)===null||s===void 0||s.forEach(N=>{H.set(N[B],N)})}else{const B=U.value;B&&H.set(B[e.valueField],B)}}}function Se(s){const{onUpdateShow:w,"onUpdate:show":$}=e;w&&de(w,s),$&&de($,s),m.value=s}function be(){le.value||(Se(!0),m.value=!0,e.filterable&&Qe())}function se(){Se(!1)}function Re(){c.value="",v.value=W}const ye=E(!1);function we(){e.filterable&&(ye.value=!0)}function je(){e.filterable&&(ye.value=!1,y.value||Re())}function Ve(){le.value||(y.value?e.filterable?Qe():se():be())}function Me(s){var w,$;!(($=(w=j.value)===null||w===void 0?void 0:w.selfRef)===null||$===void 0)&&$.contains(s.relatedTarget)||(d.value=!1,X(s),se())}function ze(s){b(s),d.value=!0}function Ge(){d.value=!0}function Ue(s){var w;!((w=z.value)===null||w===void 0)&&w.$el.contains(s.relatedTarget)||(d.value=!1,X(s),se())}function qe(){var s;(s=z.value)===null||s===void 0||s.focus(),se()}function Be(s){var w;y.value&&(!((w=z.value)===null||w===void 0)&&w.$el.contains(Fn(s))||se())}function Ee(s){if(!Array.isArray(s))return[];if(G.value)return Array.from(s);{const{remote:w}=e,{value:$}=M;if(w){const{value:H}=I;return s.filter(B=>$.has(B)||H.has(B))}else return s.filter(H=>$.has(H))}}function me(s){p(s.rawNode)}function p(s){if(le.value)return;const{tag:w,remote:$,clearFilterAfterSelect:H,valueField:B}=e;if(w&&!$){const{value:N}=v,V=N[0]||null;if(V){const re=O.value;re.length?re.push(V):O.value=[V],v.value=W}}if($&&I.value.set(s[B],s),e.multiple){const N=Ee(f.value),V=N.findIndex(re=>re===s[B]);if(~V){if(N.splice(V,1),w&&!$){const re=R(s[B]);~re&&(O.value.splice(re,1),H&&(c.value=""))}}else N.push(s[B]),H&&(c.value="");oe(N,ue(N))}else{if(w&&!$){const N=R(s[B]);~N?O.value=[O.value[N]]:O.value=W}Ye(),se(),oe(s[B],s)}}function R(s){return O.value.findIndex($=>$[e.valueField]===s)}function ne(s){y.value||be();const{value:w}=s.target;c.value=w;const{tag:$,remote:H}=e;if(P(w),$&&!H){if(!w){v.value=W;return}const{onCreate:B}=e,N=B?B(w):{[e.labelField]:w,[e.valueField]:w},{valueField:V,labelField:re}=e;C.value.some(Ce=>Ce[V]===N[V]||Ce[re]===N[re])||O.value.some(Ce=>Ce[V]===N[V]||Ce[re]===N[re])?v.value=W:v.value=[N]}}function vn(s){s.stopPropagation();const{multiple:w,tag:$,remote:H,clearCreatedOptionsOnClear:B}=e;!w&&e.filterable&&se(),$&&!H&&B&&(O.value=W),pe(),w?oe([],[]):oe(null,null)}function gn(s){!Je(s,"action")&&!Je(s,"empty")&&!Je(s,"header")&&s.preventDefault()}function pn(s){Y(s)}function Xe(s){var w,$,H,B,N;if(!e.keyboard){s.preventDefault();return}switch(s.key){case" ":if(e.filterable)break;s.preventDefault();case"Enter":if(!(!((w=z.value)===null||w===void 0)&&w.isComposing)){if(y.value){const V=($=j.value)===null||$===void 0?void 0:$.getPendingTmNode();V?me(V):e.filterable||(se(),Ye())}else if(be(),e.tag&&ye.value){const V=v.value[0];if(V){const re=V[e.valueField],{value:Ce}=f;e.multiple&&Array.isArray(Ce)&&Ce.includes(re)||p(V)}}}s.preventDefault();break;case"ArrowUp":if(s.preventDefault(),e.loading)return;y.value&&((H=j.value)===null||H===void 0||H.prev());break;case"ArrowDown":if(s.preventDefault(),e.loading)return;y.value?(B=j.value)===null||B===void 0||B.next():be();break;case"Escape":y.value&&(tr(s),se()),(N=z.value)===null||N===void 0||N.focus();break}}function Ye(){var s;(s=z.value)===null||s===void 0||s.focus()}function Qe(){var s;(s=z.value)===null||s===void 0||s.focusInput()}function bn(){var s;y.value&&((s=K.value)===null||s===void 0||s.syncPosition())}ve(),_e(te(e,"options"),ve);const mn={focus:()=>{var s;(s=z.value)===null||s===void 0||s.focus()},focusInput:()=>{var s;(s=z.value)===null||s===void 0||s.focusInput()},blur:()=>{var s;(s=z.value)===null||s===void 0||s.blur()},blurInput:()=>{var s;(s=z.value)===null||s===void 0||s.blurInput()}},en=L(()=>{const{self:{menuBoxShadow:s}}=i.value;return{"--n-menu-box-shadow":s}}),ke=r?We("select",void 0,en,e):void 0;return Object.assign(Object.assign({},mn),{mergedStatus:fe,mergedClsPrefix:n,mergedBordered:t,namespace:o,treeMate:S,isMounted:Rt(),triggerRef:z,menuRef:j,pattern:c,uncontrolledShow:m,mergedShow:y,adjustedTo:Ie(e),uncontrolledValue:l,mergedValue:f,followerRef:K,localizedPlaceholder:F,selectedOption:U,selectedOptions:_,mergedSize:ae,mergedDisabled:le,focused:d,activeWithoutMenuOpen:ye,inlineThemeDisabled:r,onTriggerInputFocus:we,onTriggerInputBlur:je,handleTriggerOrMenuResize:bn,handleMenuFocus:Ge,handleMenuBlur:Ue,handleMenuTabOut:qe,handleTriggerClick:Ve,handleToggle:me,handleDeleteOption:p,handlePatternInput:ne,handleClear:vn,handleTriggerBlur:Me,handleTriggerFocus:ze,handleKeydown:Xe,handleMenuAfterLeave:Re,handleMenuClickOutside:Be,handleMenuScroll:pn,handleMenuKeydown:Xe,handleMenuMousedown:gn,mergedTheme:i,cssVars:r?void 0:en,themeClass:ke==null?void 0:ke.themeClass,onRender:ke==null?void 0:ke.onRender})},render(){return h("div",{class:`${this.mergedClsPrefix}-select`},h(Tt,null,{default:()=>[h(_t,null,{default:()=>h(Sl,{ref:"triggerRef",inlineThemeDisabled:this.inlineThemeDisabled,status:this.mergedStatus,inputProps:this.inputProps,clsPrefix:this.mergedClsPrefix,showArrow:this.showArrow,maxTagCount:this.maxTagCount,ellipsisTagPopoverProps:this.ellipsisTagPopoverProps,bordered:this.mergedBordered,active:this.activeWithoutMenuOpen||this.mergedShow,pattern:this.pattern,placeholder:this.localizedPlaceholder,selectedOption:this.selectedOption,selectedOptions:this.selectedOptions,multiple:this.multiple,renderTag:this.renderTag,renderLabel:this.renderLabel,filterable:this.filterable,clearable:this.clearable,disabled:this.mergedDisabled,size:this.mergedSize,theme:this.mergedTheme.peers.InternalSelection,labelField:this.labelField,valueField:this.valueField,themeOverrides:this.mergedTheme.peerOverrides.InternalSelection,loading:this.loading,focused:this.focused,onClick:this.handleTriggerClick,onDeleteOption:this.handleDeleteOption,onPatternInput:this.handlePatternInput,onClear:this.handleClear,onBlur:this.handleTriggerBlur,onFocus:this.handleTriggerFocus,onKeydown:this.handleKeydown,onPatternBlur:this.onTriggerInputBlur,onPatternFocus:this.onTriggerInputFocus,onResize:this.handleTriggerOrMenuResize,ignoreComposition:this.ignoreComposition},{arrow:()=>{var e,n;return[(n=(e=this.$slots).arrow)===null||n===void 0?void 0:n.call(e)]}})}),h(kt,{ref:"followerRef",show:this.mergedShow,to:this.adjustedTo,teleportDisabled:this.adjustedTo===Ie.tdkey,containerClass:this.namespace,width:this.consistentMenuWidth?"target":void 0,minWidth:"target",placement:this.placement},{default:()=>h(jn,{name:"fade-in-scale-up-transition",appear:this.isMounted,onAfterLeave:this.handleMenuAfterLeave},{default:()=>{var e,n,t;return this.mergedShow||this.displayDirective==="show"?((e=this.onRender)===null||e===void 0||e.call(this),Gn(h(sl,Object.assign({},this.menuProps,{ref:"menuRef",onResize:this.handleTriggerOrMenuResize,inlineThemeDisabled:this.inlineThemeDisabled,virtualScroll:this.consistentMenuWidth&&this.virtualScroll,class:[`${this.mergedClsPrefix}-select-menu`,this.themeClass,(n=this.menuProps)===null||n===void 0?void 0:n.class],clsPrefix:this.mergedClsPrefix,focusable:!0,labelField:this.labelField,valueField:this.valueField,autoPending:!0,nodeProps:this.nodeProps,theme:this.mergedTheme.peers.InternalSelectMenu,themeOverrides:this.mergedTheme.peerOverrides.InternalSelectMenu,treeMate:this.treeMate,multiple:this.multiple,size:this.menuSize,renderOption:this.renderOption,renderLabel:this.renderLabel,value:this.mergedValue,style:[(t=this.menuProps)===null||t===void 0?void 0:t.style,this.cssVars],onToggle:this.handleToggle,onScroll:this.handleMenuScroll,onFocus:this.handleMenuFocus,onBlur:this.handleMenuBlur,onKeydown:this.handleMenuKeydown,onTabOut:this.handleMenuTabOut,onMousedown:this.handleMenuMousedown,show:this.mergedShow,showCheckmark:this.showCheckmark,resetMenuOnOptionsChange:this.resetMenuOnOptionsChange,scrollbarProps:this.scrollbarProps}),{empty:()=>{var o,r;return[(r=(o=this.$slots).empty)===null||r===void 0?void 0:r.call(o)]},header:()=>{var o,r;return[(r=(o=this.$slots).header)===null||r===void 0?void 0:r.call(o)]},action:()=>{var o,r;return[(r=(o=this.$slots).action)===null||r===void 0?void 0:r.call(o)]}}),this.displayDirective==="show"?[[Pt,this.mergedShow],[ln,this.handleMenuClickOutside,void 0,{capture:!0}]]:[[ln,this.handleMenuClickOutside,void 0,{capture:!0}]])):null}})})]}))}}),_l=Object.assign(Object.assign({},Dt),ce.props),El=he({name:"Tooltip",props:_l,slots:Object,__popover__:!0,setup(e){const{mergedClsPrefixRef:n}=Ae(e),t=ce("Tooltip","-tooltip",void 0,rr,e,n),o=E(null);return Object.assign(Object.assign({},{syncPosition(){o.value.syncPosition()},setShow(a){o.value.setShow(a)}}),{popoverRef:o,mergedTheme:t,popoverThemeOverrides:L(()=>t.value.self)})},render(){const{mergedTheme:e,internalExtraClass:n}=this;return h(Ht,Object.assign(Object.assign({},this.$props),{theme:e.peers.Popover,themeOverrides:e.peerOverrides.Popover,builtinThemeOverrides:this.popoverThemeOverrides,internalExtraClass:n.concat("tooltip"),ref:"popoverRef"}),this.$slots)}});export{il as N,Mn as _,sl as a,Ht as b,Bl as c,El as d,ml as e,Ol as f,tl as g,Il as h,Al as i,On as m,Dt as p,cl as r,bl as t,$t as u};
