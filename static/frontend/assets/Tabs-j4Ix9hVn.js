import{ar as ee,b2 as b,c5 as L,cW as ht,bx as gt,bs as Z,cl as xt,ae as mt,bd as Pe,cr as yt,bD as wt,b as St,d as Ct,c6 as Rt,N as Tt,a6 as G,bL as zt,G as r,O as i,D as g,J as z,P as $t,aT as ne,cg as ye,V as oe,cO as Pt,cY as _e,d5 as ie,bS as _t,d6 as Wt,cZ as Et,ay as Lt,d8 as At,m as Bt,$ as kt,cp as jt,bH as se,af as j,a_ as J,d3 as It,c0 as Ot,cz as I,Q}from"./index-Hav23vlZ.js";import{A as Ht}from"./Add-CcTvSqHb.js";import{l as Ft,h as we,q as Dt,v as Se}from"./Tooltip-DaaA4aw8.js";import{a as Mt}from"./Input-BeJH4coq.js";const Nt=we(".v-x-scroll",{overflow:"auto",scrollbarWidth:"none"},[we("&::-webkit-scrollbar",{width:0,height:0})]),Vt=ee({name:"XScroll",props:{disabled:Boolean,onScroll:Function},setup(){const e=L(null);function n(c){!(c.currentTarget.offsetWidth<c.currentTarget.scrollWidth)||c.deltaY===0||(c.currentTarget.scrollLeft+=c.deltaY+c.deltaX,c.preventDefault())}const l=ht();return Nt.mount({id:"vueuc/x-scroll",head:!0,anchorMetaName:Ft,ssr:l}),Object.assign({selfRef:e,handleWheel:n},{scrollTo(...c){var x;(x=e.value)===null||x===void 0||x.scrollTo(...c)}})},render(){return b("div",{ref:"selfRef",onScroll:this.onScroll,onWheel:this.disabled?void 0:this.handleWheel,class:"v-x-scroll"},this.$slots)}});var Xt=/\s/;function Ut(e){for(var n=e.length;n--&&Xt.test(e.charAt(n)););return n}var Gt=/^\s+/;function Yt(e){return e&&e.slice(0,Ut(e)+1).replace(Gt,"")}var Ce=NaN,qt=/^[-+]0x[0-9a-f]+$/i,Kt=/^0b[01]+$/i,Jt=/^0o[0-7]+$/i,Qt=parseInt;function Re(e){if(typeof e=="number")return e;if(gt(e))return Ce;if(Z(e)){var n=typeof e.valueOf=="function"?e.valueOf():e;e=Z(n)?n+"":n}if(typeof e!="string")return e===0?e:+e;e=Yt(e);var l=Kt.test(e);return l||Jt.test(e)?Qt(e.slice(2),l?2:8):qt.test(e)?Ce:+e}var le=function(){return xt.Date.now()},Zt="Expected a function",ea=Math.max,ta=Math.min;function aa(e,n,l){var u,c,x,v,f,h,m=0,y=!1,T=!1,E=!0;if(typeof e!="function")throw new TypeError(Zt);n=Re(n)||0,Z(l)&&(y=!!l.leading,T="maxWait"in l,x=T?ea(Re(l.maxWait)||0,n):x,E="trailing"in l?!!l.trailing:E);function C(s){var W=u,F=c;return u=c=void 0,m=s,v=e.apply(F,W),v}function S(s){return m=s,f=setTimeout(_,n),y?C(s):v}function R(s){var W=s-h,F=s-m,D=n-W;return T?ta(D,x-F):D}function P(s){var W=s-h,F=s-m;return h===void 0||W>=n||W<0||T&&F>=x}function _(){var s=le();if(P(s))return $(s);f=setTimeout(_,R(s))}function $(s){return f=void 0,E&&u?C(s):(u=c=void 0,v)}function O(){f!==void 0&&clearTimeout(f),m=0,u=h=c=f=void 0}function k(){return f===void 0?v:$(le())}function p(){var s=le(),W=P(s);if(u=arguments,c=this,h=s,W){if(f===void 0)return S(h);if(T)return clearTimeout(f),f=setTimeout(_,n),C(h)}return f===void 0&&(f=setTimeout(_,n)),v}return p.cancel=O,p.flush=k,p}var ra="Expected a function";function na(e,n,l){var u=!0,c=!0;if(typeof e!="function")throw new TypeError(ra);return Z(l)&&(u="leading"in l?!!l.leading:u,c="trailing"in l?!!l.trailing:c),aa(e,n,{leading:u,maxWait:n,trailing:c})}const fe=mt("n-tabs"),We={tab:[String,Number,Object,Function],name:{type:[String,Number],required:!0},disabled:Boolean,displayDirective:{type:String,default:"if"},closable:{type:Boolean,default:void 0},tabProps:Object,label:[String,Number,Object,Function]},fa=ee({__TAB_PANE__:!0,name:"TabPane",alias:["TabPanel"],props:We,slots:Object,setup(e){const n=Pe(fe,null);return n||yt("tab-pane","`n-tab-pane` must be placed inside `n-tabs`."),{style:n.paneStyleRef,class:n.paneClassRef,mergedClsPrefix:n.mergedClsPrefixRef}},render(){return b("div",{class:[`${this.mergedClsPrefix}-tab-pane`,this.class],style:this.style},this.$slots)}}),oa=Object.assign({internalLeftPadded:Boolean,internalAddable:Boolean,internalCreatedByPane:Boolean},zt(We,["displayDirective"])),be=ee({__TAB__:!0,inheritAttrs:!1,name:"Tab",props:oa,setup(e){const{mergedClsPrefixRef:n,valueRef:l,typeRef:u,closableRef:c,tabStyleRef:x,addTabStyleRef:v,tabClassRef:f,addTabClassRef:h,tabChangeIdRef:m,onBeforeLeaveRef:y,triggerRef:T,handleAdd:E,activateTab:C,handleClose:S}=Pe(fe);return{trigger:T,mergedClosable:G(()=>{if(e.internalAddable)return!1;const{closable:R}=e;return R===void 0?c.value:R}),style:x,addStyle:v,tabClass:f,addTabClass:h,clsPrefix:n,value:l,type:u,handleClose(R){R.stopPropagation(),!e.disabled&&S(e.name)},activateTab(){if(e.disabled)return;if(e.internalAddable){E();return}const{name:R}=e,P=++m.id;if(R!==l.value){const{value:_}=y;_?Promise.resolve(_(e.name,l.value)).then($=>{$&&m.id===P&&C(R)}):C(R)}}}},render(){const{internalAddable:e,clsPrefix:n,name:l,disabled:u,label:c,tab:x,value:v,mergedClosable:f,trigger:h,$slots:{default:m}}=this,y=c??x;return b("div",{class:`${n}-tabs-tab-wrapper`},this.internalLeftPadded?b("div",{class:`${n}-tabs-tab-pad`}):null,b("div",Object.assign({key:l,"data-name":l,"data-disabled":u?!0:void 0},wt({class:[`${n}-tabs-tab`,v===l&&`${n}-tabs-tab--active`,u&&`${n}-tabs-tab--disabled`,f&&`${n}-tabs-tab--closable`,e&&`${n}-tabs-tab--addable`,e?this.addTabClass:this.tabClass],onClick:h==="click"?this.activateTab:void 0,onMouseenter:h==="hover"?this.activateTab:void 0,style:e?this.addStyle:this.style},this.internalCreatedByPane?this.tabProps||{}:this.$attrs)),b("span",{class:`${n}-tabs-tab__label`},e?b(St,null,b("div",{class:`${n}-tabs-tab__height-placeholder`}," "),b(Ct,{clsPrefix:n},{default:()=>b(Ht,null)})):m?m():typeof y=="object"?y:Rt(y??l)),f&&this.type==="card"?b(Tt,{clsPrefix:n,class:`${n}-tabs-tab__close`,onClick:this.handleClose,disabled:u}):null))}}),ia=r("tabs",`
