...
('创建资讯', '创建一条资讯草稿。需要提供 title（标题）、summary（摘要）、content（Markdown 正文）。可选 source_url（来源链接）。', 'create_news', '{"type":"object","properties":{"title":{"type":"string","description":"资讯标题"},"summary":{"type":"string","description":"简短摘要，200字以内"},"content":{"type":"string","description":"Markdown 格式正文"},"source_url":{"type":"string","description":"原文链接（可选）"}},"required":["title","summary","content"]}', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
