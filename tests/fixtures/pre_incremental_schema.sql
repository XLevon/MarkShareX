-- Complete application schema immediately before embedded migrations 1-11.
-- Derived from the authoritative init schema, with only incremental columns,
-- indexes, and guest_copy_enabled seed removed. All unrelated tables, seeds,
-- constraints, foreign keys, and indexes intentionally remain.
...
-- Representative preservation rows and an existing explicit guest-copy choice.
INSERT INTO users (id, username, email, password_hash)
VALUES (1, 'legacy-user', 'legacy@example.invalid', 'legacy-hash');
INSERT INTO categories (id, name, slug, user_id)
VALUES (1, 'legacy-category', 'legacy-category', 1);
INSERT INTO posts (id, user_id, category_id, title, slug)
VALUES (1, 1, 1, 'legacy-post', 'legacy-post');
INSERT INTO changelog (id, version) VALUES (1, '0.1.0');
INSERT INTO guestbook (id, nickname, content)
VALUES (1, 'legacy-guest', 'legacy-message');
INSERT INTO news (id, title) VALUES (1, 'legacy-news');
INSERT INTO ai_providers (id, name) VALUES (1, 'legacy-provider');
INSERT INTO ai_skills (id, name) VALUES (1, 'legacy-skill');
INSERT INTO ai_tasks (id, name, skill_id, provider_id) VALUES (1, 'legacy-task', 1, 1);
INSERT INTO settings (key, value) VALUES ('guest_copy_enabled', 'false');
