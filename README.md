...
[![Version](https://img.shields.io/badge/version-0.2.0-blue.svg)](https://github.com/XLevon/MarkShareX)
[![License](https://img.shields.io/badge/license-MIT-blue.svg)](LICENSE)

MarkShareX 是一个面向技术创作者的轻量级自托管博客平台。高性能 Rust 后端配合现代化 Vue 3 管理后台，支持多人协同写作、本地 Markdown 编写，数据完全由你掌控。
...
- 📝 **知识管理** — 文章草稿/发布状态、二级分类归属、标签关联、封面图设置
...
- 📋 **版本说明** — 更新日志增删改维护
- 🔑 **API Key** — AI 托管，支持 X-API-Key 认证，目前仅管理员可用
...
- 📚 **OpenAPI 文档** — Scalar UI 交互式 API 文档，100+ 端点完整覆盖
...
共 100+ 个 REST API 端点，完整覆盖前后台功能。在线文档：启动后访问 `/scalar`。
...
| 角色 | 权限范围 |
|------|---------|
| **admin** | 完全权限：管理用户、资源、内容，审核申请，系统设置，AI调度 |
...
| `posts` | 文章（title/slug/content/content_html/status/封面/计数/软删除） |
